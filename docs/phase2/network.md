...
| :--- | :--- | :--- | :--- | :--- |
| **Private Subnet A** | `10.200.0.0/21` | `10.200.0.0` - `10.200.7.255` | 2.048 | **Application Layer.**  Applications (EC2, K3s Nodes). no internet access (only via NAT). max. size for scaling. |
...
* **Reason:** Container/K3s/K8s --> Pods & Services.
